local eriklib = loadstring(game:HttpGet("https://raw.githubusercontent.com/REDzHUB/RedzLibV5/main/Source.Lua"))()
local Window = redzlib:MakeWindow({
  Title = "Erik Hub V2 : Blox Fruits",
  SubTitle = "by Erik Luu",
  SaveFolder = "Erik Luu | Blox Fruits.lua"
})
...
Discord:AddDiscordInvite({
  ...
  Logo = "rbxassetid://16387366550",
  Invite = "https://discord.gg/y9ZDzhYxdx"
})
